...
| `4. Backup, restore, portability, failure modes` - operational backup and coherent restore | Core 00 §5.1, Core 01 §12.1-§12.2, Core 04 §2, §4.4, §4.5, §6, §9.0.1, §9.14, and §12 | Appendix B, Appendix E | — | illustration only |
...
| REQ-00-035 | Core 00 §5.1 Contract-owner matrix | base | AC-231 |
...
| REQ-01-025 | Core 01 §3.3.2 Session and authentication routes | base | AC-123, AC-130, AC-156..AC-162, AC-231, AC-244..AC-250, AC-311 |
...
| REQ-01-168 | Core 01 §3.3.5.3.1 Incident list, retrieval, and metadata patch contract | base | AC-127, AC-170..AC-174, AC-211..AC-214, AC-219..AC-220, AC-231 |
...
| REQ-01-173 | Core 01 §3.3.5.3.1 Incident list, retrieval, and metadata patch contract | base | AC-170..AC-174, AC-211..AC-214, AC-219..AC-220, AC-231 |
| REQ-01-174 | Core 01 §3.3.5.3.1 Incident list, retrieval, and metadata patch contract | base | AC-170..AC-174, AC-211..AC-214, AC-219..AC-220, AC-231 |
| REQ-01-175 | Core 01 §3.3.5.3.1 Incident list, retrieval, and metadata patch contract | base | AC-170..AC-174, AC-211..AC-214, AC-219..AC-220, AC-231 |
...
| REQ-01-238 | Core 01 §3.3.6.2 Canonical public reason-code registries | base | AC-126, AC-203..AC-208, AC-211, AC-213..AC-214, AC-218..AC-219, AC-231, AC-239..AC-240, AC-252, AC-255, AC-260, AC-293, AC-321..AC-328, AC-375 |
...
| REQ-01-312 | Core 01 §7.4.1 `cartulary.view.timeline.v1` | base | AC-118, AC-119, AC-124..AC-125, AC-184, AC-191..AC-198, AC-231, AC-300..AC-301, AC-303, AC-331..AC-332 |
...
| REQ-01-315 | Core 01 §7.4.1 `cartulary.view.timeline.v1` | base | AC-118, AC-119, AC-124..AC-125, AC-184, AC-191..AC-198, AC-231, AC-388..AC-391 |
| REQ-01-316 | Core 01 §7.4.1 `cartulary.view.timeline.v1` | base | AC-118, AC-119, AC-124..AC-125, AC-184, AC-191..AC-198, AC-231, AC-388..AC-391 |
...
| REQ-01-542 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-370 |
| REQ-01-543 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-370 |
| REQ-01-544 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-370..AC-371 |
| REQ-01-545 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-370 |
| REQ-01-546 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-370..AC-371 |
| REQ-01-547 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-371 |
| REQ-01-548 | Core 01 §3.3.3.1 Runtime extension discovery and reserved-unclaimed extension semantics | base | AC-371 |
...
| REQ-01-481 | Core 01 §17.4 Reference Pack Extension Profile public contract | reference_pack | AC-270..AC-271, AC-308..AC-309, AC-326, AC-369 |
...
| REQ-02-202 | Core 02 §14.1 Persistence realization status and deployment-local invariants | base, import, snapshot_reporting, reference_pack | AC-017..AC-018, AC-072..AC-075, AC-118, AC-128, AC-154..AC-155, AC-188..AC-190, AC-200..AC-204, AC-231..AC-234, AC-277..AC-278, AC-280 |
...
| REQ-02-249 | Core 02 §14.1 Persistence realization status and deployment-local invariants | incident_portability | AC-236, AC-409 |
...
| REQ-02-204 | Core 02 §14.1 Persistence realization status and deployment-local invariants | base, incident_portability | AC-231, AC-236, AC-409 |
...
| REQ-02-216 | Core 02 §15.2 Mutation-entry unit | base | AC-215..AC-217, AC-231, AC-384 |
...
| REQ-02-222 | Core 02 §18 Canonical closed-vocabulary registry | base, incident_portability | AC-076..AC-084, AC-121..AC-122, AC-137..AC-145, AC-231, AC-236, AC-252..AC-253, AC-277, AC-284, AC-285, AC-287 |
| REQ-02-223 | Core 02 §18 Canonical closed-vocabulary registry | base | AC-076..AC-084, AC-121..AC-122, AC-137..AC-145, AC-231, AC-252..AC-253, AC-277 |
...
| REQ-03-011 | Core 03 §2.2 System views | base | AC-078, AC-085..AC-090, AC-121..AC-122, AC-231, AC-281..AC-284, AC-410 |
...
| REQ-04-038 | Core 04 §3 Attribution and audit requirements | base, incident_portability | AC-175, AC-231, AC-236, AC-343..AC-344, AC-346, AC-409 |
...
| REQ-04-105 | Core 04 §2 Authorization model | base | AC-370..AC-371 |
...
| AC-125 | REQ-00-014, REQ-01-019..REQ-01-022, REQ-01-057..REQ-01-088, REQ-01-285..REQ-01-290, REQ-01-307..REQ-01-330, REQ-01-349..REQ-01-350, REQ-02-208..REQ-02-209, REQ-03-086, REQ-03-111..REQ-03-115, REQ-03-236..REQ-03-241 |
...
| AC-170 | REQ-01-152..REQ-01-180, REQ-02-203, REQ-02-243 |
...
| AC-219 | REQ-01-021, REQ-01-152..REQ-01-180, REQ-01-228..REQ-01-239 |
| AC-220 | REQ-01-021, REQ-01-152..REQ-01-180 |
...
| AC-289 | REQ-01-510..REQ-01-511, REQ-01-514..REQ-01-515, REQ-04-018 |
| AC-290 | REQ-01-031, REQ-01-510, REQ-01-512, REQ-01-515, REQ-04-018, REQ-04-020 |
